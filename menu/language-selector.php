...
<div id="lang_sel">
    <ul>
        <li><a href="#" class="lang_sel_sel icl-<?php echo $w_this_lang['code'] ?>">
            ...
            <img class="iclflag" src="<?php echo $main_language['country_flag_url'] ?>" alt="<?php echo $main_language['language_code'] ?>" />                                
            &nbsp;<?php endif;?>
            ...
            <ul>
                ...
                <li class="icl-<?php echo $lang['language_code'] ?>">          
                    ...
                    <?php if($this->settings['icl_lso_flags']):?>                
                    <img class="iclflag" src="<?php echo $lang['country_flag_url'] ?>" alt="<?php echo $lang['language_code'] ?>" />&nbsp;                    
                    <?php endif; ?>
