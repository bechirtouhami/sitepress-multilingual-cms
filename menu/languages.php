                                ...
                                <td>
                                    ...
                                    <ul>
										...
										<li class="icl_advanced_feature">
                                            ...
                                            <p><?php echo __('Show language selector in footer?', 'sitepress') ?></p>
                                            <ul>
                                                <li>
                                                    <label>
                                                        <input type="checkbox" name="icl_lang_sel_footer" value="1" <?php if($sitepress_settings['icl_lang_sel_footer']):?>checked="checked"<?php endif?> />
										 ...
										 <?php if($sitepress_settings['icl_lang_sel_footer']): ?>                                            
                                            <div id="icl_lang_sel_preview_wrap" style="height:80px">                                            
                                            <span id="icl_lang_sel_preview">                                            
                                            <h4><?php _e('Language switcher preview', 'sitepress')?></h4>
                                            <?php 
                                                global $icl_language_switcher_preview;
                                                $icl_language_switcher_preview = true;                                                
                                                $sitepress->language_selector_footer(); 
                                            ?>                                                                          
                                            </span>                                                                     
                                            </div>
                                            <?php endif; ?>
...
<?php foreach($language_switcher_defaults_alt as $key=>$val): ?>
                                                <?php foreach($language_switcher_defaults as $k=>$v): ?>                                                
                                                <input type="hidden" id="icl_lang_sel_footer_config_alt_<?php echo $key ?>_<?php echo $k ?>" value="<?php echo $language_switcher_defaults_alt[$key][$k] ?>" />
                                                <?php endforeach; ?>
                                            <?php endforeach; ?>                                            
                                                ...
                                                <table id="icl_lang_preview_config_footer" style="width:auto;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" size="7" id="icl-lang-sel-footer-config-font-current-normal" name="icl_lang_sel_footer_config[font-current-normal]" value="<?php 
                                                            if(isset($sitepress_settings['icl_lang_sel_footer_config']['font-current-normal'])) 
                                                                echo $sitepress_settings['icl_lang_sel_footer_config']['font-current-normal']; 
                                                            else 
                                                                echo $language_switcher_defaults['font-current-normal'] ;
                                                        ...
                                                        <td><input type="text" size="7" id="icl-lang-sel-footer-config-font-current-hover" name="icl_lang_sel_footer_config[font-current-hover]" value="<?php 
                                                            if(isset($sitepress_settings['icl_lang_sel_footer_config']['font-current-hover'])) 
                                                                echo $sitepress_settings['icl_lang_sel_footer_config']['font-current-hover']; 
                                                            else 
                                                                echo $language_switcher_defaults['font-current-hover'] ;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" size="7" id="icl-lang-sel-footer-config-background-current-normal" name="icl_lang_sel_footer_config[background-current-normal]" value="<?php 
                                                            if(isset($sitepress_settings['icl_lang_sel_footer_config']['background-current-normal'])) 
                                                                echo $sitepress_settings['icl_lang_sel_footer_config']['background-current-normal']; 
                                                            else 
                                                                echo $language_switcher_defaults['background-current-normal'] ;
                                                        ...
                                                        <td><input type="text" size="7" id="icl-lang-sel-footer-config-background-current-hover" name="icl_lang_sel_footer_config[background-current-hover]" value="<?php 
                                                            if(isset($sitepress_settings['icl_lang_sel_footer_config']['background-current-hover'])) 
                                                                echo $sitepress_settings['icl_lang_sel_footer_config']['background-current-hover']; 
                                                            else 
                                                                echo $language_switcher_defaults['background-current-hover'] ;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" size="7" id="icl-lang-sel-footer-config-font-other-normal" name="icl_lang_sel_footer_config[font-other-normal]" value="<?php 
                                                            if(isset($sitepress_settings['icl_lang_sel_footer_config']['font-other-normal'])) 
                                                                echo $sitepress_settings['icl_lang_sel_footer_config']['font-other-normal']; 
                                                            else 
                                                                echo $language_switcher_defaults['font-other-normal'] ;
                                                        ...
                                                        <td><input type="text" size="7" id="icl-lang-sel-footer-config-font-other-hover" name="icl_lang_sel_footer_config[font-other-hover]" value="<?php 
                                                            if(isset($sitepress_settings['icl_lang_sel_footer_config']['font-other-hover'])) 
                                                                echo $sitepress_settings['icl_lang_sel_footer_config']['font-other-hover']; 
                                                            else 
                                                                echo $language_switcher_defaults['font-other-hover'] ;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" size="7" id="icl-lang-sel-footer-config-background-other-normal" name="icl_lang_sel_footer_config[background-other-normal]" value="<?php 
                                                            if(isset($sitepress_settings['icl_lang_sel_footer_config']['background-other-normal'])) 
                                                                echo $sitepress_settings['icl_lang_sel_footer_config']['background-other-normal']; 
                                                            else 
                                                                echo $language_switcher_defaults['background-other-normal'] ;
                                                        ...
                                                        <td><input type="text" size="7" id="icl-lang-sel-footer-config-background-other-hover" name="icl_lang_sel_footer_config[background-other-hover]" value="<?php 
                                                            if(isset($sitepress_settings['icl_lang_sel_footer_config']['background-other-hover'])) 
                                                                echo $sitepress_settings['icl_lang_sel_footer_config']['background-other-hover']; 
                                                            else 
                                                                echo $language_switcher_defaults['background-other-hover'] ;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" size="7" id="icl-lang-sel-footer-config-border" name="icl_lang_sel_footer_config[border]" value="<?php 
                                                            if(isset($sitepress_settings['icl_lang_sel_footer_config']['border'])) 
                                                                echo $sitepress_settings['icl_lang_sel_footer_config']['border']; 
                                                            else 
                                                                echo $language_switcher_defaults['border'] ;
